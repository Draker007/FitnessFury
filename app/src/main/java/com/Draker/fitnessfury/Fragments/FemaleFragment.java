...
public class FemaleFragment extends Fragment implements customExcersiceAdapter.onCustomExcersiceListner{
    ...
    public void onStart() {
        super.onStart();
        DatabaseReference setData = mDatabase.child("ExcersiceSets").child("Women");
...
//                    progressBar.setVisibility(View.INVISIBLE);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView)v.findViewById(R.id.femaleRecycler);
